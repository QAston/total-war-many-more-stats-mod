...
# ability phases
tsv_file = open("special_ability_to_special_ability_phase_junctions_tables_special_ability_to_special_ability_phase_junctions.tsv")
...
with open('new_unit_abilities.loc.tsv', 'w', newline='') as out_file:
    tsv_writer = csv.writer(out_file, delimiter='\t', quoting=csv.QUOTE_NONE, quotechar='')
    rowid = 0
    for row in read_tsv:
        rowid = rowid + 1
